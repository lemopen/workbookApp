...
public class Sentence{
	...
	public static String whichWord = "テキストを区切るための単語を１つ入力してください。正規表現も利用できます\n例）Question.*\\n もしくは 第.*条\\n など";
	public static String putAnyWord = "何らかの単語を入力してください";
	public static String putExportDir = "作成した問題をファイルに出力するディレクトリのパスを入力してください。\n入力の最後は\\マークにして下さい\n例）C:\\Users\\SampleFolder\\";
	public static String putExportFileName = "先ほどのディレクトリに出力するファイルの名前を決めてください\n例）Sample.txt";
